...
export class FloorListComponent implements OnInit {
  ...
  resetSelect(nzNode: NzTreeNode) {
    ...
    this.args = {communityId: nzNode.origin.object._id}
    this.st.pi = 1;
  ...
  ngOnInit() {
    this.args = {communityId: this.node.origin.object._id}
    this.st.pi = 1;
    this.st.reload(this.args)
  }
  ...
  showModal(item: any): void {
    if (item) {
      ...
      this.i = {}
      this.i.companyId = this.node.getParentNode().origin.object._id;
      this.i.companyName = this.node.getParentNode().origin.object.name;
      this.i.communityId = this.node.origin.object._id;
      this.i.communityName = this.node.origin.object.name;
    }
    this.isVisible = true;
  }
